...
$langs['gallery_2'] = "GALLERY";
$langs['budva'] = "Budva";
$langs['guestbook'] = "Guestbook";
$langs['guest_book'] = "GUEST BOOK";
$langs['guest_book_intro'] = "Your feedback means the world to us.";
$langs['contact'] = "Contact";
$langs['contact_intro'] = "Want to get in touch with us ? Send us a mail, phone or send message via this form.";
$langs['hotel_reviews'] = "Now with hotel reviews by";
$langs['check_avail'] = "CHECK AVAILABILITY";
$langs['guests'] = "Guests";
$langs['ariv_date'] = "Arrival Date";
$langs['dep_date'] = "Departure Date";
$langs['check'] = "Check";
